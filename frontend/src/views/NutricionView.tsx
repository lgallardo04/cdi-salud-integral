    ...
    <div className="view-container">
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
          ...
          >
            <span style={{ fontSize: '0.7rem', textTransform: 'uppercase', opacity: 0.85, display: 'block' }}>
              Pacientes Fichados
            </span>
            <span style={{ fontSize: '1.1rem', fontWeight: 800 }}>{data.pacientes?.length || 24}</span>
          </div>
          ...
          >
            ...
            <span style={{ fontSize: '1.1rem', fontWeight: 800 }}>4 Activos</span>
          </div>
          ...
          >
            ...
            <span style={{ fontSize: '1.1rem', fontWeight: 800 }}>M / T</span>
          </div>
        </div>
      </div>
