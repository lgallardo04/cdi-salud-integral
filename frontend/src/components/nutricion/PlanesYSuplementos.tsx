...
export const PlanesYSuplementos: React.FC = () => {
  ...
  const handleEntregaSubmit = (e: React.FormEvent) => {
    ...
    if (supSeleccionado.stock < entregaForm.cantidad) {
      addToast(`Stock insuficiente de ${supSeleccionado.nombre} (disponible: ${supSeleccionado.stock})`, 'warning');
      return;
    }

    supSeleccionado.stock -= entregaForm.cantidad;
    ...
    addToast(`Entrega de ${entregaForm.cantidad}x ${supSeleccionado.nombre} procesada correctamente`, 'success');
  };
          ...
          <div className="lg:col-span-2 bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-4">
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <button
                ...
                onClick={() => addToast('Plan alimentario guardado y asignado exitosamente al paciente.', 'success')}
              >
